...
.nl{font-family:var(--fd);font-size:1.1rem;font-weight:400;letter-spacing:.18em;text-transform:uppercase;color:var(--g1);line-height:1}
.nl .hub{color:var(--g1)}.nl .sep{color:rgba(201,168,76,.45);margin:0 6px;font-weight:300}
...
<footer>
  <div class="ftg">
    <div>
      <div class="flog">The <span style="color:rgba(201,168,76,.45);margin:0 4px;font-weight:300">·</span> NCA Hub</div>
